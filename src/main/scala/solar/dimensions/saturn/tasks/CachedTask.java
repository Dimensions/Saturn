...
import solar.dimensions.saturn.Constants;
import solar.dimensions.saturn.HashUtils;

import groovy.lang.Closure;

/**
 * A base task that will cache things annotated with @Cached.
 * Pulled this from ForgeGradle. TODO: Write my own caching system
 *
 * @author AbrarSyed
 */
public abstract class CachedTask extends DefaultTask {
    ...
    protected static @interface Cached {

    }

    @Target({ElementType.FIELD, ElementType.METHOD})
    @Retention(RetentionPolicy.RUNTIME)
    protected static @interface Excluded {
